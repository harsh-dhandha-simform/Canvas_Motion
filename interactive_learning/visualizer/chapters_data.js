    ...
    "challenges": [
      {
        ...
        "data": {
          "steps": [
            ...
            {
              "id": "c5",
              "label": "Establish TCP Connection"
            },
            {
              "id": "c6",
              "label": "Perform TLS Handshake"
            },
            {
              "id": "c7",
    ...
    "challenges": [
      {
        ...
        "data": {
          "steps": [
            {
              "id": "c1",
              "label": "Notification Service sends confirmation email"
            },
            {
              "id": "c2",
              "label": "Order Service stores the order"
            },
            {
              "id": "c3",
              "label": "Frontend sends POST /orders"
            },
            {
              "id": "c4",
              "label": "API Gateway routes the request"
            },
            {
              "id": "c5",
              "label": "Order Service publishes an OrderCreated event"
            },
            {
              "id": "c6",
              "label": "Message Queue receives the event"
            }
          ]
        }
      },
    ...
    "challenges": [
      {
        ...
        "data": {
          "steps": [
            {
              "id": "c1",
              "label": "Server processes the request"
            },
            {
              "id": "c2",
              "label": "Load Balancer selects a healthy server"
            },
            {
              "id": "c3",
              "label": "Health Check confirms server availability"
            },
            {
              "id": "c4",
            ...
            {
              "id": "c5",
              "label": "Response is returned to the user"
            }
          ]
        }
      },
      {
        ...
        "data": {
          ...
          "options": [
            {
              "id": "op1",
              "label": "Upgrade to a larger server (Vertical Scaling)"
            },
            {
              "id": "op2",
              "label": "Add multiple servers behind a Load Balancer (Horizontal Scaling)"
            },
            {
              "id": "op3",
              "label": "Increase RAM only"
            },
            {
              "id": "op4",
              "label": "Disable health checks to improve performance"
            }
          ]
        }
      }
