"""Component-catalog accessors (ported from test-remotion backend/component_catalog.py).
The agents NEVER see React; they only read this metadata + JSON-Schemas, which are
generated from renderer_remotion/src/registry.ts by `npm run catalog`. Only the
catalog-path source was rewritten for eduvideo (settings.catalog_path)."""
