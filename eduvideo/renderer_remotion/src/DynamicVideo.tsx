  ...
  return (
    <ThemeProvider theme={theme}>
      <AbsoluteFill style={{ backgroundColor: theme.background }}>
        ...
        {/* Global TTS Audio. eduvideo passes a filename served from this project's
            public/ dir (via staticFile) rather than test-remotion's original
            hardcoded dev-server URL, so rendering doesn't depend on any backend
            being up. A full http(s) URL still works unchanged if ever needed. */}
        {audio_url && (
          <Audio src={/^https?:\/\//.test(audio_url) ? audio_url : staticFile(audio_url)} />
        )}
